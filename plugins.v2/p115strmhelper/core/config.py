...
class BaseConfig(BaseModel):
    ...
    # 分享目录
    user_share_pan_path: Optional[str] = "/media"
    # 本地 STRM 目录
    user_share_local_path: Optional[str] = "/media/strm"
    ...
    directory_upload_path: Optional[List[Dict]] = [
        {
            "local_path": "/media/movie",
            "pan_path": "/media/movie", 
            "copy_path": "/media/strm/movie"
        }
    ]
